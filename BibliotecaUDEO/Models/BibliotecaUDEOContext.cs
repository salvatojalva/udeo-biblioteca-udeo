...
{
    public partial class BibliotecaUDEOContext : DbContext
    {
        public BibliotecaUDEOContext()
        {
        }

        public BibliotecaUDEOContext(DbContextOptions<BibliotecaUDEOContext> options)
            : base(options)
        {
        }
